...
export class PostService {
	...
	constructor(AuthService) {
		...
		if (!this.posts) {
			this.posts = [
				{
					...
					author: 'Nick Shallee',
					slug: 'my-first-post',
					tags: ['aurelia', 'lorem', 'zamur', 'javascript'],
          ...
          body: 'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Facilis aut deserunt ea saepe expedita eum modi consequuntur excepturi unde optio esse a maiores natus magni, voluptas recusandae. Quasi atque eum placeat qui explicabo dolorum. Quam, distinctio! Voluptates sapiente cumque amet!',
					author: 'Zamur Borges',
					slug: 'my-fourth-post',
					tags: ['novo', 'zamur'],
					createdAt: new Date('February 26, 2019')
				}
			]
		}
	}
